...
class FlavorWire(BaseModel):
    ...
    settings: Dict[str, Any] = Field(
        default_factory=dict,
        description=(
            "How a switched-on feature behaves — copy, limits, labels. "
            "Opaque here too: the widget's flavor chunk reads its own keys "
            "and falls back to its compiled-in defaults for anything unset."
        ),
    )
